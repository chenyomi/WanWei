...
Page({
  ...
  fetchProject() {
    ...
    var that = this
    wx.request({
      url: app.globalData.ApiUrl + '/Order/GetBookingOrderList',
      data: {
      ...
      success: function (res) {
        ...
        if (res.data.code != 1) {
          ...
          for (var i = 0; i < newlist.length; i++) {
            ...
            newlist[i].Difference = newlist[i].BookingCount - newlist[i].HasBookingCount;
            data1 = new Date(newlist[i].BookingEndTime)
